...
[travis-badge]: https://travis-ci.org/filipesilva/angular-org-chart.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-org-chart
...
1. Create a project folder (you can call it `org-chart` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-org-chart.git
cd angular-org-chart
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-org-chart/archive/master.zip)
...
Use your editor to search the project for all instances of `angular-org-chart` and change it
